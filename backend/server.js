...
/*************** Reports *************/
app.get("/reports/weekly-income", async (req, res) => {
    try{
        const now = new Date();
...
app.get("/reports/last-three-months-weekly-income", async (req, res) => {
    try {
        const now = new Date();
        now.setHours(23, 59, 59, 999);
...
app.get("/reports/last-month-daily-income", async (req, res) => {
    try {
        const now = new Date();
        now.setHours(23, 59, 59, 999);
...
app.get("/reports/yearly-income", async (req, res) => {
    try {
        const now = new Date();
        now.setHours(23, 59, 59, 999);
