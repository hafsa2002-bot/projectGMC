...
router.post("/admin/dashboard/add-requested-product", protect, async(req, res) => {
    try{
        ...
        await newProduct.save()
         ...
         // log activity
        await logActivity(req.user._id, req.user.name, "Requested Product added", `${reqProductName}`)
...
router.delete("/admin/dashboard/delete-requested-product/:id", protect, async(req, res) => {
    try{
        ...
        console.log("deleted product: ", deletedProduct)
         ...
         // log activity
        await logActivity(req.user._id, req.user.name, "Requested Product deleted", `${deletedProduct.reqProductName}`)
