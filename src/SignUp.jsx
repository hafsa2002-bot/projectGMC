...
import {Ratio, UserRoundPlus} from 'lucide-react'
    ...
    <div className="flex flex-col items-center justify-center h-screen gap-20 bg-[url('https://brandio.io/envato/iofrm/html/images/graphic8.svg')] bg-[500px_auto] bg-no-repeat bg-center">
        ...
        <div className='w-96 rounded-xl  bg-white flex flex-col items-center pb-5 relative bottom-9'>
            ...
            <form className=' w-9/12 flex flex-col items-center mt-7 mb-4' action="" method="post">
                ...
                <button   className='bg-blue-600 text-white font-medium px-3 py-2 mt-4  rounded-lg w-10/12 placeholder-gray-600'>Create Account</button>
            </form>
            <p className='text-gray-500 text-sm'>Already have an account? <Link to="/login" className='text-blue-600 font-medium'>Login</Link></p>
        </div>
    </div>
    </>
  )
