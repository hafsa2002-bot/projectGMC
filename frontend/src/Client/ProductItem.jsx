...
function ProductItem(props) {
  ...
  return (
    <>
        <div className=' w-64  overflow-hidden shadow-lg shadow-gray-400 rounded-md pb-3 group'>
            <div className='relative'>
                <img className='h-72 w-full ' src={props.val.images[0]} />
                <div className='absolute flex gap-2 bottom-3 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
