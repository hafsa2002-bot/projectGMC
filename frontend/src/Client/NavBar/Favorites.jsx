...
function Favorites({setShowFavorite}) {
  ...
  return (
    <div className='bg-white text-black lg:w-[450px] w-full absolute lg:top-20 top-28  right-0 border-l border-gray-300 shadow-2xl h-[90vh] lg:pl-5 pl-2.5 pr-2 pt-3 pb-10 overflow-y-scroll'>
      <div className='flex justify-between items-center pt-2 pb-4'>
        <p className='text-xl font-mono'>Favoris</p> 
        <div
        ...
        ?(
          ...
          <div className=' flex flex-col justify-center items-center gap-6 h-[73vh]'>
            <div className='flex flex-col justify-center items-center text-gray-300'>
              ...
              <p className='text-gray-500 font-semibold'>Votre liste de souhaits est vide</p>
            </div>
            <div 
              onClick={() => {
                navigate("/products")
