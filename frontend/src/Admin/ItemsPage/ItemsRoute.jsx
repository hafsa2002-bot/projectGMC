...
function ItemsRoute() {
  ...
  return (
    ...
    { (!location.pathname.startsWith("/admin/items/view")) && (
      <div className={`${(location.pathname == "/admin/items/out-of-stock" || location.pathname == "/admin/items/low-in-stock" || location.pathname == "/admin/items/expired-items" || location.pathname === "/admin/items/add-item" ) ? 'hidden' :' bg-gray-100 border-b border-gray-400 flex justify-between items-center my-5 '}`} >
