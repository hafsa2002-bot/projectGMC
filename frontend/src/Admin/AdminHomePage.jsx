...
function AdminHomePage() {
  ...
  return (
    <div>
      <div className='border-b mb-5 border-gray-400 flex justify-between items-center py-5 pr-4'>
          ...
          <div className='relative w-9 h-9 hover:bg-gray-300 rounded-full flex justify-center items-center' onMouseEnter={() => setShowNotifiactionTitle(true)} onMouseLeave={() => setShowNotifiactionTitle(false)}>
            ...
            {showNotifications && (
              <div className=' absolute bg-white w-96 h-[85vh] right-10 top-0 rounded-xl shadow-2xl'>
                <div className='border-b border-gray-400 text-gray-600 px-3 py-1 text-lg'>Notifications</div>
                  {(showNotificationExpired || showNotificationLowInStock || showNotificationOutOfStock) ? (
                    <>
                <div className='flex flex-col gap-[0.1px] mt-5'>
                      {showNotificationOutOfStock && (
                          <div className='bg-blue-100 px-3 text-gray-600 py-2  flex items-center justify-between border-t border-b border-gray-400'>
                      ...
                      {showNotificationLowInStock && (
                          <div className='bg-orange-100 px-3 text-gray-600 py-2  flex items-center justify-between border-t border-b border-gray-400'>
                      ...
                      {showNotificationExpired && (
                          <div className='bg-red-100 px-3 text-gray-600 py-2  flex items-center justify-between border-t border-b border-gray-400'>
