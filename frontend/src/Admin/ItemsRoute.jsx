    ...
    <div>
      <div className=' bg-gray-100 border-b border-gray-400 flex justify-between items-center my-5 '>
        <div className='flex  gap-5 text-2xl '>
            <NavLink
              className={({isActive}) => (isActive && (location.pathname === "/admin/items" || location.pathname === "/admin/items/add-item" )) ? 'text-blue-600 border-b-3 border-blue-700 pb-5 font-semibold px-3 ' : 'px-2 text-gray-500 font-semibold'} 
              to="/admin/items">
              <p>Items</p>
            </NavLink>
            <NavLink
              className={({isActive}) => (isActive &&  location.pathname=== "/admin/items/categories" ) ? 'text-blue-600 font-semibold border-b-3 border-blue-700 pb-5 px-3' : 'text-gray-500 px-2 font-semibold'}
